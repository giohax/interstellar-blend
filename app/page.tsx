    ...
    <>
      ...
      {!isMobile  ? (
        ...
        <div className="absolute inset-0 flex items-center justify-center flex-col px-4">
          ...
          <h2 className="text-white text-2xl lg:text-3xl font-bold font-vandiana text-center custom-shadow">BECOME LIMITLESS WITH OUR PROPRIETARY HERBS</h2>
          ...
          <Link href="/search" className="mt-2 bg-custom-black hover:bg-red-500 text-white text-md lg:text-lg font-bold py-3 px-6 w-full md:w-64 rounded-full shadow-lg text-center font-vandiana cursor-pointer">LEARN MORE</Link>
        </div>
        <style jsx>{`
          .custom-shadow {
            text-shadow: 0 0 10px rgba(255, 255, 255, 0.5);  // dark shadow for small screens
          }
