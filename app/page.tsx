    ...
    <>
      ...
      {!isMobile  ? (
        ...
        <div className="absolute inset-0 flex items-center justify-center flex-col">
          <h1 className="text-white text-6xl font-bold font-vandiana text-center tracking-tighter custom-shadow">INTERSTELLAR BLEND</h1>
          <h2 className="text-white text-2xl font-bold font-vandiana text-center custom-shadow">BECOME LIMITLESS WITH OUR PROPRIETARY HERBS</h2>
          <Link href="/search" className="mt-8 bg-white hover:bg-gray-100 text-black text-md text-lg font-bold py-3 px-6 rounded-full shadow-lg font-vandiana cursor-pointer">SHOP NOW</Link>
        </div>
        <style jsx>{`
          .custom-shadow {
