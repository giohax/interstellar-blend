...
export function GridTileImage({
  ...
  return (
    <div>
      <div
        className={clsx('relative flex flex-col h-full w-full items-center justify-center overflow-hidden rounded-md', {
        ...
        {props.src ? (
          <Image
            className={clsx('relative h-full w-full object-contain', {
              'transition duration-300 ease-in-out md:hover:scale-105': isInteractive
            })}
            {...props}
            alt={props.title || ''}
          />
